    ...
    <div>
        ...
        <main class="profile-page">
            <section class="relative block h-[500px]">
                <div class="pofile-banner absolute top-0 w-full h-full bg-center bg-cover">
                        ...
                        <div class="px-6">
                            <div class="flex flex-wrap justify-center">
                                <div class="w-full lg:w-3/12 px-4 lg:order-2 flex justify-center">
                                    <div class="relative">
                                        <img class="shadow-xl rounded-full h-auto align-middle border-none  max-w-150-px" src="https://demos.creative-tim.com/notus-js/assets/img/team-2-800x800.jpg" alt="">
...
<style scoped>
.pofile-banner{
    background: url(./../assets/img/banner/hero_bg.png);
